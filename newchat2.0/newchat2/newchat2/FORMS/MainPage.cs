...
namespace newchat2
{
    ...
    {
        //<<<<<<< HEAD
        public static string connection = @"Data Source=DESKTOP-CAV5533\SQLEXPRESS;Initial Catalog=Chat;Integrated Security=True";//@"Data Source=dbsrv\sql2021;Initial Catalog=chat2.0;Integrated Security=True";
