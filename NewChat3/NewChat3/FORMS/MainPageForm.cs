...
namespace NewChat3
{
    ...
    {
        //<<<<<<< HEAD
        public static string connection = @"Data Source=DESKTOP-H4QAP6P;Initial Catalog=TOWORKWITHCS;Integrated Security=True"; //@"Data Source=dbsrv\sql2021;Initial Catalog=chat2.0;Integrated Security=True";
